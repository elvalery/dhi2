        ...
        <div class="about__content">
          @if(app()->getLocale() == 'ru')
            ...
            <p class="about__txt">Компания, с главным офисом в Киеве и представительством в Роттердаме, более 6 лет,
              успешно работает над проектами не только на территории СНГ, но и за его пределами, предоставляя
            ...
            <p class="about__txt"><strong>International experience.</strong> Благодаря большому опыту проектирования за
              границей – Голландия, Великобритания, Австралия – и широкой партнёрской сети, у нас есть возможность
          ...
          @else
            <p class="about__txt"><strong>Design Hub International</strong> is an integrated design practice with its HQ
              office based in Kiev and representative office in Rotterdam, which provides architectural, engineering,
            ...
            <h3 class="mb-3"><strong>Key benefits of working with Design Hub International:</strong></h3>
